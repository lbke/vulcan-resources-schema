export const MusicRecording = {
  ...
  recordingOf: {
    ...
    resolveAs: {
      fieldName: "MusicCompositionResolved",
      type: "MusicComposition",
      resolver: (document, args, context) => {
        return context.MusicComposition.findOne(
          { _id: document.MusicComposition },
          {
            fields: context.MusicComposition.getViewableFields(
              context.currentUser,
              context.MusicComposition
            ),
          }
        )
      },
  ...
  inPlaylist: {
    ...
    resolveAs: {
      fieldName: "MusicPlaylistResolved",
      type: "MusicPlaylist",
      resolver: (document, args, context) => {
        return context.MusicPlaylist.findOne(
          { _id: document.MusicPlaylist },
          {
            fields: context.MusicPlaylist.getViewableFields(
              context.currentUser,
              context.MusicPlaylist
            ),
          }
        )
      },
