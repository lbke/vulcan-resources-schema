export const AggregateOffer = {
  ...
  description: `When a single product is associated with multiple offers (for example, the same
...
indicate a category hierarchy.`,
  ...
  addOn: {
    label: "addOn",
    description: `An additional offer that can only be obtained in combination with the first base
