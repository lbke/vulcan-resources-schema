export const LiveBlogPosting = {
  ...
  description: `A blog post intended to provide a rolling textual coverage of an ongoing event
through continuous updates.`,
  ...
  coverageStartTime: {
    ...
    description: `The time when the live blog will begin covering the Event. Note that coverage
...
before coverage begins.`,
  ...
  coverageEndTime: {
    ...
    description: `The time when the live blog will stop covering the Event. Note that coverage may
continue after the Event concludes.`,
  ...
  liveBlogUpdate: {
    ...
    resolveAs: {
      fieldName: "BlogPostingResolved",
      type: "BlogPosting",
      resolver: (document, args, context) => {
        return context.BlogPosting.findOne(
          { _id: document.BlogPosting },
          {
            fields: context.BlogPosting.getViewableFields(
              context.currentUser,
              context.BlogPosting
            ),
          }
...
school/university, a club, or a team.`,
  ...
  sharedContent: {
    label: "sharedContent",
    description: `A CreativeWork such as an image, video, or audio clip shared as part of this
posting.`,
    resolveAs: {
      fieldName: "CreativeWorkResolved",
      type: "CreativeWork",
  ...
  pagination: {
    label: "pagination",
    description: `Any description of pages that is not separated into pageStart and pageEnd; for
example, "1-6, 9, 55" or "10-12, 46-49".`,
  ...
  articleSection: {
    ...
    description: `Articles may belong to one or more 'sections' in a magazine or newspaper, such
