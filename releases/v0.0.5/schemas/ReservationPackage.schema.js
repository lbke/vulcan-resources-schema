export const ReservationPackage = {
  ...
  subReservation: {
    ...
    description: `The individual reservations included in the package. Typically a repeated
property.`,
    resolveAs: {
      fieldName: "ReservationResolved",
      type: "Reservation",
      resolver: (document, args, context) => {
        return context.Reservation.findOne(
          { _id: document.Reservation },
          {
            fields: context.Reservation.getViewableFields(
              context.currentUser,
              context.Reservation
            ),
          }
