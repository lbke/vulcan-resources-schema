...
be associated with individual items or with a series, episode, clip.`,
  ...
  subtitleLanguage: {
    ...
    description: `Languages in which subtitles/captions are available, in IETF BCP 47 standard
format.`,
    type: String,
    canRead: ["guests"],
    canCreate: ["members"],
  ...
  countryOfOrigin: {
    ...
    description: `The country of the principal offices of the production company or individual
