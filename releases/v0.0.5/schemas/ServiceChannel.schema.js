export const ServiceChannel = {
  ...
  description: `A means for accessing a service, e.g. a government office location, web site, or
phone number.`,
  _id: {
    canRead: ["guests"],
    canCreate: ["members"],
  ...
  serviceLocation: {
    ...
    description: `The location (e.g. civic structure, local business, etc.) where a person can go
