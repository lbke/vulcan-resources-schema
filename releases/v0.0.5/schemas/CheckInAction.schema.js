export const CheckInAction = {
  label: "CheckInAction",
  description: `The act of an agent communicating (service provider, social media, etc) their
 ...
 * ConfirmAction: Unlike ConfirmAction, CheckInAction implies that the agent is
   informing/confirming the start of a previously reserved service rather than
