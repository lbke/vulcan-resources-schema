export const MusicRelease = {
  ...
  creditedTo: {
    label: "creditedTo",
    description: `The group the release is credited to if different than the byArtist. For
...
Gaga.`,
  ...
  releaseOf: {
    ...
    resolveAs: {
      fieldName: "MusicAlbumResolved",
      type: "MusicAlbum",
      resolver: (document, args, context) => {
        return context.MusicAlbum.findOne(
          { _id: document.MusicAlbum },
          {
            fields: context.MusicAlbum.getViewableFields(
              context.currentUser,
              context.MusicAlbum
            ),
          }
...
format.`,
  ...
  musicReleaseFormat: {
    ...
    description: `Format of this release (the type of recording media used, ie. compact disc,
digital media, LP, etc.).`,
    resolveAs: {
      fieldName: "MusicReleaseFormatTypeResolved",
      type: "MusicReleaseFormatType",
      resolver: (document, args, context) => {
        return context.MusicReleaseFormatType.findOne(
          { _id: document.MusicReleaseFormatType },
          {
            fields: context.MusicReleaseFormatType.getViewableFields(
              context.currentUser,
              context.MusicReleaseFormatType
            ),
          }
        )
      },
