export const GovernmentService = {
  ...
  description: `A service provided by a government organization, e.g. food stamps, veterans
benefits, etc.`,
  _id: {
    canRead: ["guests"],
    canCreate: ["members"],
  ...
  serviceOperator: {
    ...
    description: `The operating organization, if different from the provider. This enables the
