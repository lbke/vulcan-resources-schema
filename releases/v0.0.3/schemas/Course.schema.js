export const Course = {
  label: "Course",
  description: `A description of an educational course which may be offered as distinct
...
web page, scholarly article, etc.`,
  ...
  coursePrerequisites: {
    ...
    description: `Requirements for taking the Course. May be completion of another Course or a
...
pre-requisite competency, referenced using AlignmentObject.`,
  ...
  hasCourseInstance: {
    ...
    description: `An offering of the course at a specific time and place or through specific media
or mode of study or to a specific section of students.`,
    viewableBy: ["guests"],
    editableBy: ["members"],
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "CourseInstanceResolved",
      type: "CourseInstance",
      resolver: (document, args, context) => {
        return context.CourseInstance.findOne(
          { _id: document.CourseInstance },
          {
            fields: context.CourseInstance.getViewableFields(
              context.currentUser,
