export const CreativeWorkSeries = {
  label: "CreativeWorkSeries",
  description: `A CreativeWorkSeries in schema.org is a group of related items, typically but
...
MovieSeries, BookSeries, Periodical and VideoGameSeries. In each case, the 
hasPart / isPartOf properties can be used to relate the CreativeWorkSeries to
its parts. The general CreativeWorkSeries type serves largely just to organize
