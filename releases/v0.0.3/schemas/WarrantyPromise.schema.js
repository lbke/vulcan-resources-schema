export const WarrantyPromise = {
  ...
  description: `A structured value representing the duration and scope of services that will be
...
disambiguation.`,
  ...
  durationOfWarranty: {
    ...
    description: `The duration of the warranty promise. Common unitCode values are ANN for year,
MON for months, or DAY for days.`,
  ...
  warrantyScope: {
    ...
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "WarrantyScopeResolved",
      type: "WarrantyScope",
      resolver: (document, args, context) => {
        return context.WarrantyScope.findOne(
          { _id: document.WarrantyScope },
          {
            fields: context.WarrantyScope.getViewableFields(
              context.currentUser,
              context.WarrantyScope
            ),
          }
        )
      },
