export const SoftwareSourceCode = {
  ...
  description: `Computer programming source code. Example: Full (compile ready) solutions, code
...
web page, scholarly article, etc.`,
  ...
  targetProduct: {
    label: "targetProduct",
    description: `Target Operating System / Product to which the code applies. If applies to
several versions, just the product name can be used.`,
  ...
  codeRepository: {
    ...
    description: `Link to the repository where the un-compiled, human readable code and related
code is located (SVN, github, CodePlex).`,
  ...
  codeSampleType: {
    ...
    description: `What type of code sample: full (compile ready) solution, code snippet, inline
code, scripts, template.`,
  ...
  runtimePlatform: {
    ...
    description: `Runtime platform or script interpreter dependencies (Example - Java v1,
