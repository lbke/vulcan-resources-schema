export const PeopleAudience = {
  label: "PeopleAudience",
  description: `A set of characteristics belonging to people, e.g. who compose an item's target
audience.`,
  _id: {
    viewableBy: ["guests"],
    editableBy: ["members"],
...
disambiguation.`,
  ...
  audienceType: {
    label: "audienceType",
    description: `The target group associated with a given audience (e.g. veterans, car owners,
musicians, etc.).`,
    viewableBy: ["guests"],
    editableBy: ["members"],
    insertableBy: ["members"],
