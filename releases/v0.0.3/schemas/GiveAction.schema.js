export const GiveAction = {
  label: "GiveAction",
  description: `The act of transferring ownership of an object to a destination. Reciprocal of
TakeAction.
 ...
 * SendAction: Unlike SendAction, GiveAction implies that ownership is being
   transferred (e.g. I may send my laptop to you, but that doesn't mean I'm
   giving it to you).`,
  _id: {
    viewableBy: ["guests"],
    editableBy: ["members"],
