export const BroadcastService = {
  ...
  description: `A delivery service through which content is provided via broadcast over the air
or online.`,
  _id: {
    viewableBy: ["guests"],
    editableBy: ["members"],
...
an organization or business person.`,
  ...
  parentService: {
    label: "parentService",
    description: `A broadcast service to which the broadcast service may belong to such as
regional variations of a national channel.`,
  ...
  broadcastDisplayName: {
    ...
    description: `The name displayed in the channel guide. For many US affiliates, it is the
network name.`,
    viewableBy: ["guests"],
    editableBy: ["members"],
    insertableBy: ["members"],
