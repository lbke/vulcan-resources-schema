export const InteractionCounter = {
  ...
  description: `A summary of how users have interacted with this CreativeWork. In most cases,
...
disambiguation.`,
  ...
  interactionService: {
    ...
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "WebSiteResolved",
      type: "WebSite",
      resolver: (document, args, context) => {
        return context.WebSite.findOne(
          { _id: document.WebSite },
          {
            fields: context.WebSite.getViewableFields(
              context.currentUser,
              context.WebSite
            ),
          }
...
SoftwareApplication.`,
  ...
  interactionType: {
    ...
    description: `The Action representing the type of interaction. For up votes, +1s, etc. use 
