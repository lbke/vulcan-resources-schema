export const CompoundPriceSpecification = {
  label: "CompoundPriceSpecification",
  description: `A compound price specification is one that bundles multiple prices that all
...
for the CompoundPriceSpecification node.`,
    ...
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "UnitPriceSpecificationResolved",
      type: "UnitPriceSpecification",
      resolver: (document, args, context) => {
        return context.UnitPriceSpecification.findOne(
          { _id: document.UnitPriceSpecification },
          {
            fields: context.UnitPriceSpecification.getViewableFields(
              context.currentUser,
              context.UnitPriceSpecification
            ),
          }
        )
      },
