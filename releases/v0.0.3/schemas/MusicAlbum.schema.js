...
list should contain items of type MusicRecording.`,
    ...
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "MusicRecordingResolved",
      type: "MusicRecording",
      resolver: (document, args, context) => {
        return context.MusicRecording.findOne(
          { _id: document.MusicRecording },
          {
            fields: context.MusicRecording.getViewableFields(
              context.currentUser,
              context.MusicRecording
            ),
          }
        )
      },
  ...
  albumProductionType: {
    ...
    description: `Classification of the album by it's type of content: soundtrack, live album,
studio album, etc.`,
    viewableBy: ["guests"],
    editableBy: ["members"],
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "MusicAlbumProductionTypeResolved",
      type: "MusicAlbumProductionType",
      resolver: (document, args, context) => {
        return context.MusicAlbumProductionType.findOne(
          { _id: document.MusicAlbumProductionType },
          {
            fields: context.MusicAlbumProductionType.getViewableFields(
              context.currentUser,
              context.MusicAlbumProductionType
            ),
          }
        )
      },
  ...
  albumReleaseType: {
    ...
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "MusicAlbumReleaseTypeResolved",
      type: "MusicAlbumReleaseType",
      resolver: (document, args, context) => {
        return context.MusicAlbumReleaseType.findOne(
          { _id: document.MusicAlbumReleaseType },
          {
            fields: context.MusicAlbumReleaseType.getViewableFields(
              context.currentUser,
              context.MusicAlbumReleaseType
            ),
          }
        )
      },
  ...
  albumRelease: {
    ...
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "MusicReleaseResolved",
      type: "MusicRelease",
      resolver: (document, args, context) => {
        return context.MusicRelease.findOne(
          { _id: document.MusicRelease },
          {
            fields: context.MusicRelease.getViewableFields(
              context.currentUser,
              context.MusicRelease
            ),
          }
        )
      },
