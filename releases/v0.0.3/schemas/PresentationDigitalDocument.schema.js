export const PresentationDigitalDocument = {
...
web page, scholarly article, etc.`,
  ...
  hasDigitalDocumentPermission: {
    ...
    description: `A permission related to the access to this document (e.g. permission to read or
...
Audience with audienceType equal to "public".`,
    ...
    insertableBy: ["members"],
    resolveAs: {
      fieldName: "DigitalDocumentPermissionResolved",
      type: "DigitalDocumentPermission",
      resolver: (document, args, context) => {
        return context.DigitalDocumentPermission.findOne(
          { _id: document.DigitalDocumentPermission },
          {
            fields: context.DigitalDocumentPermission.getViewableFields(
              context.currentUser,
              context.DigitalDocumentPermission
            ),
          }
        )
      },
