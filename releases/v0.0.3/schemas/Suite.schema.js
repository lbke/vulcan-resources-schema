export const Suite = {
  label: "Suite",
  description: `A suite in a hotel or other public accommodation, denotes a class of luxury
...
person, or place.`,
  ...
  floorSize: {
    label: "floorSize",
    description: `The size of the accommodation, e.g. in square meter or squarefoot. Typical unit
code(s): MTK for square meter, FTK for square foot, or YDK for square yard`,
  ...
  petsAllowed: {
    label: "petsAllowed",
    description: `Indicates whether pets are allowed to enter the accommodation or lodging
business. More detailed information can be put in a text value.`,
  ...
  numberOfRooms: {
    label: "numberOfRooms",
    description: `The number of rooms (excluding bathrooms and closets) of the accommodation or
lodging business. Typical unit code(s): ROM for room or C62 for no unit. The
type of room can be put in the unitText property of the QuantitativeValue.`,
  ...
  occupancy: {
    label: "occupancy",
    description: `The allowed total occupancy for the accommodation in persons (including infants
...
room used by a single person). Typical unit code(s): C62 for person`,
    viewableBy: ["guests"],
    editableBy: ["members"],
    insertableBy: ["members"],
    resolveAs: {
  ...
  bed: {
    label: "bed",
    description: `The type of bed or beds included in the accommodation. For the single case of
just one bed of a certain type, you use bed directly with a text. If you want to
indicate the quantity of a certain kind of bed, use an instance of BedDetails.
