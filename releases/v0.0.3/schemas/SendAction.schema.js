export const SendAction = {
  label: "SendAction",
  description: `The act of physically/electronically dispatching an object for transfer from an
origin to a destination.Related actions:

 * ReceiveAction: The reciprocal of SendAction.
 * GiveAction: Unlike GiveAction, SendAction does not imply the transfer of
   ownership (e.g. I can send you my laptop, but I'm not necessarily giving it
   to you).`,
  _id: {
    viewableBy: ["guests"],
    editableBy: ["members"],
