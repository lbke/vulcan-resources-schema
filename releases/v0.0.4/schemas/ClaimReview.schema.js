export const ClaimReview = {
  label: "ClaimReview",
  description: `A fact-checking review of claims made (or reported) in some creative work
...
school/university, a club, or a team.`,
  ...
  reviewRating: {
    label: "reviewRating",
    description: `The rating given in this review. Note that reviews can themselves be rated. The 
