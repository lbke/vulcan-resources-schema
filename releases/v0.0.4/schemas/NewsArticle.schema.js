export const NewsArticle = {
  label: "NewsArticle",
  description: `A NewsArticle is an article whose content reports news, or provides background
...
A more detailed overview of schema.org News markup is also available.`,
  ...
  printSection: {
    label: "printSection",
    description: `If this NewsArticle appears in print, this field indicates the print section in
which the article appeared.`,
  ...
  printPage: {
    label: "printPage",
    description: `If this NewsArticle appears in print, this field indicates the name of the page
...
exact page name (e.g. A5, B18).`,
  ...
  dateline: {
    label: "dateline",
    description: `A dateline is a brief piece of text included in news articles that describes
