export const BusTrip = {
  ...
  departureBusStop: {
    ...
    resolveAs: {
      fieldName: "BusStationResolved",
      type: "BusStation",
      resolver: (document, args, context) => {
        return context.BusStation.findOne(
          { _id: document.BusStation },
          {
            fields: context.BusStation.getViewableFields(
              context.currentUser,
              context.BusStation
            ),
          }
  ...
  arrivalBusStop: {
    ...
    resolveAs: {
      fieldName: "BusStopResolved",
      type: "BusStop",
      resolver: (document, args, context) => {
        return context.BusStop.findOne(
          { _id: document.BusStop },
          {
            fields: context.BusStop.getViewableFields(
              context.currentUser,
              context.BusStop
            ),
          }
