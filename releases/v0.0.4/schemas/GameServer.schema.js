export const GameServer = {
  ...
  game: {
    ...
    resolveAs: {
      fieldName: "VideoGameResolved",
      type: "VideoGame",
      resolver: (document, args, context) => {
        return context.VideoGame.findOne(
          { _id: document.VideoGame },
          {
            fields: context.VideoGame.getViewableFields(
              context.currentUser,
              context.VideoGame
            ),
          }
  ...
  serverStatus: {
    ...
    resolveAs: {
      fieldName: "GameServerStatusResolved",
      type: "GameServerStatus",
      resolver: (document, args, context) => {
        return context.GameServerStatus.findOne(
          { _id: document.GameServerStatus },
          {
            fields: context.GameServerStatus.getViewableFields(
              context.currentUser,
              context.GameServerStatus
            ),
          }
        )
      },
