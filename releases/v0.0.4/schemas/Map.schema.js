export const Map = {
  ...
  mapType: {
    ...
    resolveAs: {
      fieldName: "MapCategoryTypeResolved",
      type: "MapCategoryType",
      resolver: (document, args, context) => {
        return context.MapCategoryType.findOne(
          { _id: document.MapCategoryType },
          {
            fields: context.MapCategoryType.getViewableFields(
              context.currentUser,
              context.MapCategoryType
            ),
          }
        )
      },
