export const TouristAttraction = {
  ...
  description: `A tourist attraction. In principle any Thing can be a TouristAttraction, from a 
...
examples below)`,
  ...
  touristType: {
    label: "touristType",
    description: `Attraction suitable for type(s) of tourist. eg. Children, visitors from a
