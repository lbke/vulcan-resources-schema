export const DigitalDocumentPermission = {
  ...
  grantee: {
    label: "grantee",
    description: `The person, organization, contact point, or audience that has been granted this
permission.`,
    resolveAs: {
  ...
  permissionType: {
    ...
    resolveAs: {
      fieldName: "DigitalDocumentPermissionTypeResolved",
      type: "DigitalDocumentPermissionType",
      resolver: (document, args, context) => {
        return context.DigitalDocumentPermissionType.findOne(
          { _id: document.DigitalDocumentPermissionType },
          {
            fields: context.DigitalDocumentPermissionType.getViewableFields(
              context.currentUser,
              context.DigitalDocumentPermissionType
            ),
          }
        )
      },
