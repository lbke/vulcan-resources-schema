...
followed by a colon.`,
  ...
  billingIncrement: {
    ...
    description: `This property specifies the minimal quantity and rounding increment that will be
...
property.`,
  ...
  referenceQuantity: {
    ...
    description: `The reference quantity for which a certain price applies, e.g. 1 EUR per 4 kWh
...
provide a standard unit code forunitCode.`,
  ...
  priceType: {
    label: "priceType",
    description: `A short text or acronym indicating multiple price specifications for the same
