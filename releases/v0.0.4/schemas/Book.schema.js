export const Book = {
  ...
  bookFormat: {
    ...
    resolveAs: {
      fieldName: "BookFormatTypeResolved",
      type: "BookFormatType",
      resolver: (document, args, context) => {
        return context.BookFormatType.findOne(
          { _id: document.BookFormatType },
          {
            fields: context.BookFormatType.getViewableFields(
              context.currentUser,
              context.BookFormatType
            ),
          }
        )
      },
