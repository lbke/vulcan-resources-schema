export const LoanOrCredit = {
  label: "LoanOrCredit",
  description: `A financial product for the loaning of an amount of money under agreed terms and
charges.`,
  _id: {
    viewableBy: ["guests"],
    editableBy: ["members"],
  ...
  requiredCollateral: {
    ...
    description: `Assets required to secure loan or credit repayments. It may take form of third
