export const PerformanceRole = {
  ...
  description: `A PerformanceRole is a Role that some entity places with regard to a theatrical
performance, e.g. in a Movie, TVSeries etc.`,
  ...
  characterName: {
    label: "characterName",
    description: `The name of a character played in some acting or performing role, i.e. in a
PerformanceRole.`,
    type: String,
    viewableBy: ["guests"],
    editableBy: ["members"],
...
school/university, a club, or a team.`,
  ...
  namedPosition: {
    label: "namedPosition",
    description: `A position played, performed or filled by a person or organization, as part of
...
position named 'Quarterback'.`,
  ...
  roleName: {
    label: "roleName",
    description: `A role played, performed or filled by a person or organization. For example, the
