export const MenuSection = {
  label: "MenuSection",
  description: `A sub-grouping of food or drink items in a menu. E.g. courses (such as 'Dinner',
...
etc.), or some other classification made by the menu provider.`,
  ...
  hasMenuItem: {
    ...
    resolveAs: {
      fieldName: "MenuItemResolved",
      type: "MenuItem",
      resolver: (document, args, context) => {
        return context.MenuItem.findOne(
          { _id: document.MenuItem },
          {
            fields: context.MenuItem.getViewableFields(
              context.currentUser,
              context.MenuItem
            ),
          }
  ...
  hasMenuSection: {
    ...
    resolveAs: {
      fieldName: "MenuSectionResolved",
      type: "MenuSection",
      resolver: (document, args, context) => {
        return context.MenuSection.findOne(
          { _id: document.MenuSection },
          {
            fields: context.MenuSection.getViewableFields(
              context.currentUser,
              context.MenuSection
            ),
          }
