export const MediaObject = {
  label: "MediaObject",
  description: `A media object, such as an image, video, or audio object embedded in a web page
...
Allowed values are true or false (note that an earlier version had 'yes', 'no').`,
  ...
  regionsAllowed: {
    ...
    description: `The regions where the media is allowed. If not specified, then it's assumed to
be allowed everywhere. Specify the countries in ISO 3166 format.`,
  ...
  embedUrl: {
    label: "embedUrl",
    description: `A URL pointing to a player for a specific video. In general, this is the
...
content of the loc tag.`,
  ...
  associatedArticle: {
    ...
    resolveAs: {
      fieldName: "NewsArticleResolved",
      type: "NewsArticle",
      resolver: (document, args, context) => {
        return context.NewsArticle.findOne(
          { _id: document.NewsArticle },
          {
            fields: context.NewsArticle.getViewableFields(
              context.currentUser,
              context.NewsArticle
            ),
          }
  ...
  productionCompany: {
    ...
    description: `The production company or studio responsible for the item e.g. series, video
game, episode etc.`,
    resolveAs: {
