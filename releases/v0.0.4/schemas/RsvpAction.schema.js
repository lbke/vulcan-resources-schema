export const RsvpAction = {
  label: "RsvpAction",
  description: `The act of notifying an event organizer as to whether you expect to attend the
event.`,
  _id: {
    viewableBy: ["guests"],
    editableBy: ["members"],
  ...
  additionalNumberOfGuests: {
    ...
    description: `If responding yes, the number of guests who will attend in addition to the
invitee.`,
    type: Number,
    input: "number",
    viewableBy: ["guests"],
  ...
  rsvpResponse: {
    ...
    resolveAs: {
      fieldName: "RsvpResponseTypeResolved",
      type: "RsvpResponseType",
      resolver: (document, args, context) => {
        return context.RsvpResponseType.findOne(
          { _id: document.RsvpResponseType },
          {
            fields: context.RsvpResponseType.getViewableFields(
              context.currentUser,
              context.RsvpResponseType
            ),
          }
        )
      },
