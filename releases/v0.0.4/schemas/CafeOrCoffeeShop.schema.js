...
school/university, a club, or a team.`,
  ...
  hasMenu: {
    label: "hasMenu",
    description: `Either the actual menu as a structured representation, as text, or a URL of the
menu.`,
    type: String,
    input: "url",
    viewableBy: ["guests"],
...
menu.`,
    resolveAs: {
      fieldName: "MenuResolved",
      type: "Menu",
      resolver: (document, args, context) => {
        return context.Menu.findOne(
          { _id: document.Menu },
          {
            fields: context.Menu.getViewableFields(
              context.currentUser,
              context.Menu
            ),
          }
  ...
  starRating: {
    label: "starRating",
    description: `An official rating for a lodging business or food establishment, e.g. from
...
DEHOGA, WHR, or Hotelstars).`,
  ...
  acceptsReservations: {
    ...
    description: `Indicates whether a FoodEstablishment accepts reservations. Values can be
