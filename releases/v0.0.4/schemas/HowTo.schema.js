export const HowTo = {
  label: "HowTo",
  description: `Instructions that explain how to achieve a result by performing a sequence of
steps.`,
  _id: {
    viewableBy: ["guests"],
    editableBy: ["members"],
...
(originally misnamed 'steps'; 'step' is preferred).`,
  ...
  prepTime: {
    label: "prepTime",
    description: `The length of time it takes to prepare the items to be used in instructions or a
direction, in ISO 8601 duration format.`,
  ...
  step: {
    label: "step",
    description: `A single step item (as HowToStep, text, document, video, etc.) or a
HowToSection.`,
    resolveAs: {
      fieldName: "HowToStepResolved",
      type: "HowToStep",
      resolver: (document, args, context) => {
        return context.HowToStep.findOne(
          { _id: document.HowToStep },
          {
            fields: context.HowToStep.getViewableFields(
              context.currentUser,
              context.HowToStep
            ),
          }
  ...
  performTime: {
    label: "performTime",
    description: `The length of time it takes to perform instructions or a direction (not
...
instructions.`,
  ...
  totalTime: {
    label: "totalTime",
    description: `The total time required to perform instructions or a direction (including time
to prepare the supplies), in ISO 8601 duration format.`,
  ...
  yield: {
    label: "yield",
    description: `The quantity that results by performing instructions. For example, a paper
