export const Question = {
  label: "Question",
  description: `A specific question - e.g. from a user seeking answers online, or collected in a
Frequently Asked Questions (FAQ) document.`,
  ...
  upvoteCount: {
    label: "upvoteCount",
    description: `The number of upvotes this question, answer or comment has received from the
community.`,
    resolveAs: {
      fieldName: "IntegerResolved",
      type: "Integer",
  ...
  suggestedAnswer: {
    ...
    description: `An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a
Question/Answer site.`,
  ...
  downvoteCount: {
    label: "downvoteCount",
    description: `The number of downvotes this question, answer or comment has received from the
community.`,
    resolveAs: {
      fieldName: "IntegerResolved",
      type: "Integer",
